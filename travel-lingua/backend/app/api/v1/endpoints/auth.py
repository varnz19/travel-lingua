...
async def register_user(request: SignupRequest):
    """
    Receives user signup credentials from the React Native app
    and saves the new profile record into Supabase PostgreSQL database tables.
    """
    ...
    return SignupResponse(
        ...
        email=user_email,
        name=request.name,
        message="User profile registered successfully in database",
